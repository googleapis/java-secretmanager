...
[google-cloud-java/java-secretmanager](
https://github.com/googleapis/google-cloud-java/tree/main/java-secretmanager).
This repository will be archived in the future.
Future releases will appear in the new repository (https://github.com/googleapis/google-cloud-java/releases).
The Maven artifact coordinates (`com.google.cloud:google-cloud-secretmanager`) remain the same.
...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-secretmanager" % "2.12.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-secretmanager/2.12.0
