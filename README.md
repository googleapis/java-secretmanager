...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-secretmanager" % "2.0.0"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-secretmanager/tree/master/samples) directory.
